...
public class Phase1 implements Phase {
    public void selectionJoueur(List<Joueur> j4){
        for (Joueur joueur : j4) { //changement de l'état des 4 joueurs sélectionnés
            joueur.updateEtat("sélectionné·e");
            System.out.println("Player" + joueur.getNum() + " a été sélectionné !");
        }
    }

    public void deroulerPhaseJeu(List<Joueur> j4){
    ...
    public void currPhase(String aleaTheme, List<Joueur> j4, int i){
        ...
        for (Joueur joueur : j4) { //on itère sur les 4 joueurs
            ...
            {
                joueur.majScore(2); //incrémentation du score
    ...
    public List<String> currThemes(List<String> tmp, List<Joueur> j2)
    {
        ...
        t.choixUnTheme(aleaTheme); //enregistrement de ce theme pour ne pas qu'il revienne en phase 2 au premier tour
